...
<tr>
    <td style="color: #000000; font-size: 14px; color: #000; font-family: 'Rubik', sans-serif; line-height: 22px;">
        ...
        <span style="font-weight: 500;">
            Vielen Dank, wir haben Deine Zahlung per PayPal erhalten. Dein Funduskonto wurde nun auf {{ config('app.max_articles_fundus_pro') }} Artikel erweitert. Im Anhang findest Du die Rechnung zu Deinem Funduskonto Pro
        </span>
    </td>
</tr>
<tr>
...
<tr>
    <td height="50" align="center"><a href="mailto:all@setbakers.de" target="_blank" rel="noopener" style="background: #8fb3bc;
                                      color: #ffffff;
                                      font-size: 12px;
