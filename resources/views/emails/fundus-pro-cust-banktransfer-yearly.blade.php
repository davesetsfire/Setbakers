...
<tr>
    <td style="color: #000000; font-size: 14px; color: #000; font-family: 'Rubik', sans-serif; line-height: 22px;">
        <span style="font-weight: 500;">Hallo <span>username</span>,</span><br>
        <br>
        <span style="font-weight: 500;">
            Im Anhang findest Du die aktuelle Rechnung zu Deinem Funduskonto Pro.
            Bitte überweise den Betrag von
        </span>
    </td>
</tr>
<tr>
    <td height="80" align="center" style="color: #8FB3BB; font-size: 16px; font-family: 'Rubik', sans-serif; line-height: 22px; font-weight:500;">AMOUNT OF MONEY</td>
</tr>
<tr>
...
<tr>
    <td style="color: #000000; font-size: 14px; color: #000; font-family: 'Rubik', sans-serif; line-height: 22px;">
        ...
        BIC: SOBKDEB2XXX<br>
        Verwendungszweck: INVOICE NUMBER<br>
        Bankinstitut: SOLARIS BANK
    </td>
</tr>
<tr>
    <td height="80">&nbsp;</td>
