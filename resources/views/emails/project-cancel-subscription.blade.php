...
<tr>
    <td style="color: #000000; font-size: 14px; color: #000; font-family: arial; line-height: 22px;">
        <strong>Hallo {{ $name }},</strong><br>
            <br>
            <strong>Dein Projektkonto wird zum {{ $emailData['subscriptionEndDate'] }} gekündigt.  Du kannst Dein Abo jederzeit unter “Meine Daten” in deinem Kundenkonto fortführen. Wir freuen uns schon auf Dein nächstes Projekt!</strong><br>
        <br>
