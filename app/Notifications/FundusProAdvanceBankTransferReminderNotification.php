...
class FundusProAdvanceBankTransferReminderNotification extends Notification {
    ...
    public function toMail($notifiable) {
        $template = 'emails.fundus-pro-cust-advanced-banktransfer-reminder';
        $mailMessageObject = new MailMessage();
        $mailMessageObject->subject('Rechnung zu Deinem Funduskonto Pro')
                ->view($template, [
                    'name' => $this->name,
